...
*   **Smart Global Frame Budget**: Exposed `selection.global_max_frames: 25` to cap the total frames sent to the LLM, reducing costs on excessively long videos while preserving narrative logic.
